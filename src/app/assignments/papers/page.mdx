...
We encourage both members of the presentation group to submit the PDF
(i.e., because this is easiest for course staff monitoring of Canvas assignments),
but submission by either member will be sufficient
(i.e., if only one member of the presentation group submits,
we will manually give credit to the other).
